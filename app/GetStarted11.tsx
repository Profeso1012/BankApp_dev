...
import CaretLeft1 from "../old/assets/CaretLeft.svg";
import FrameComponent6 from "../old/components/FrameComponent6";
import FrameComponent7 from "../old/components/FrameComponent7";
import Password from "../old/components/Password";

export default function GetStarted11() {
  ...
  return (
    ...
    >
      ...
      <View style={styles.getStarted1Inner2}>
        <View style={styles.checkboxParent}>
          ...
          <Text style={[styles.iHaveReadContainer, styles.step15Typo]}>
            <Text style={styles.iHaveRead}>{`I have read and I understand Swift Pay Bank’s `}</Text>
