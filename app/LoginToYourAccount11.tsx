...
import CaretLeft6 from "../old/assets/CaretLeft.svg";
import FrameComponent6 from "../old/components/FrameComponent6";
import InputField from "../old/components/InputField";

export default function LoginToYourAccount11() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.logInToYourSwiftPayAccouWrapper, styles.wrapperSpaceBlock]}>
...
const styles = StyleSheet.create({
  ...
  icon: { nodeWidth: 24, nodeHeight: 24 },
  logInToYourSwiftPayAccouWrapper: { height: Height.height_68 },
  logInTo: {
  ...
  inputFieldWrapper: { height: 479, paddingBottom: 323 },
});
